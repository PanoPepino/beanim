...
beamer_green = {
    ...
    "decorator_color": "#096E30",  # color of the decorator fill and frame
    "decorator_color_2": "#09AC7B",  # color of the decorator fill and frame
...
Tex.set_default(tex_template=beamer_green['tex_temp'], color= BLACK)
...
Text_General.set_default(  # Be careful with general size
    text_size=beamer_green['text_size'],
    text_color=BLACK,
    decorator_presence=beamer_green['decorator_presence_1'],
    decorator_color=beamer_green['decorator_color'],
    decorator_stroke_width=beamer_green['decorator_stroke_width'],
    corner_rad=beamer_green['corner_rad'],
    corner_rad_direction=beamer_green['corner_rad_direction'],
    fill_opa=beamer_green['fill_opa'],
    tightness=beamer_green['tightness'],
    stroke_opa=beamer_green['stroke_opa'],
    dot_scale=beamer_green['dot_scale'],
    direction=beamer_green['direction'],
    aligned_direction=beamer_green['aligned_direction_1']
)

Title_Presentation.set_default(
    decorator_presence="box",
    tightness=3*beamer_green['tightness'],
    text_color=WHITE,
)

Title_Section.set_default(
    decorator_presence=beamer_green['decorator_presence_2'],
    tightness=1.3*beamer_green['tightness'],
    text_color=WHITE
...
Reference.set_default(
    text_size=0.5 * beamer_green['text_size'],
    decorator_presence=beamer_green['decorator_presence_3'],
    aligned_direction=beamer_green['aligned_direction_2'],
    text_color=WHITE
)
# Any equation
...
Table.set_default(
    highlight_top="yes",
    text_size=beamer_green['text_size'],
    text_color=beamer_green['text_color'],
    decorator_presence="box",
    decorator_color=beamer_green['decorator_color'],
    decorator_color_2=beamer_green['decorator_color_2'],
    decorator_color_3=beamer_green['decorator_color_3'],
    decorator_color_4=beamer_green['decorator_color_4'],
    decorator_stroke_width=beamer_green['decorator_stroke_width'],
    corner_rad=beamer_green['corner_rad'],
    corner_rad_direction=beamer_green['corner_rad_direction'],
    fill_opa=0.1,
    h_tightness=beamer_green['h_tightness'],
    v_tightness=beamer_green['v_tightness'],
    tightness=0,  # So the border of the table is the box without any extra space.
    stroke_opa=beamer_green['stroke_opa'],
    stroke_color=beamer_green['decorator_color_2']
)


# Photo Frame
Photo.set_default(
    decorator_style=beamer_green['decorator_style'],
    decorator_color=beamer_green['decorator_color'],
    text_size=0.75 * beamer_green['text_size'],
    text_color=beamer_green['text_size'],
    pin_color=beamer_green['text_color'],
    corner_rad=beamer_green['corner_rad'],
    decorator_stroke_w=beamer_green['decorator_stroke_width']
)
